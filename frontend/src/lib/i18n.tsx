...
type Dict = {
  nav: { adultes: string; tournoi: string; enligne: string; tarifs: string; resultats: string; blog: string }
  reserve: string
  reserveFirst: string
  viewPricing: string
  openMenu: string
...
export const UI: Record<Locale, Dict> = {
  fr: {
    nav: { adultes: 'Cours adultes', tournoi: 'Préparation tournoi', enligne: 'En ligne', tarifs: 'Tarifs', resultats: 'Résultats', blog: 'Blog' },
  ...
  en: {
    nav: { adultes: 'Adult lessons', tournoi: 'Tournament prep', enligne: 'Online', tarifs: 'Pricing', resultats: 'Results', blog: 'Blog' },
